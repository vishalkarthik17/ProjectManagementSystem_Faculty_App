...
public class Approve_Request extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Approve Resources Request");

        mAuth = FirebaseAuth.getInstance();
        one = findViewById(R.id.disp_sel); //TextBox Link
        proceed = findViewById(R.id.Approve);
        reselec=findViewById(R.id.reselectt);

        final ArrayAdapter<String> adp = new ArrayAdapter<String>(Approve_Request.this, android.R.layout.simple_list_item_1, al);//List Adapter,with al set
        abc = FirebaseDatabase.getInstance().getReference();
        gg = FirebaseDatabase.getInstance().getReference();

        lv = findViewById(R.id.ReqList);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (sal.size() == 0) {
                    ...
                    Toast.makeText(Approve_Request.this, "You can only Approve One at a time", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(sal.size()==1) {
                    gg.child("Resources").child(sal.get(0)).child("status").setValue("Y");
                    Intent rel = new Intent(Approve_Request.this, Approve_Request.class);
                    startActivity(rel);
                    finish();
                }
                else {
                    Toast.makeText(Approve_Request.this, "You Have to Select Atleat 1 to approve", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        reselec.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent reload=new Intent(Approve_Request.this,Approve_Request.class);
